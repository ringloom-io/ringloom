...
pub const broker_reserved_length_offset: usize = 296;
...
/// Offset and length of the Aeron discovery region in v2 metadata files.
pub const aeron_discovery_region_offset_offset: usize = 344;
pub const aeron_discovery_region_length_offset: usize = 352;
...
/// Max Aeron fragments read per network-loop poll before yielding back to agents.
pub const aeron_fragment_read_limit: u32 = 64;
...
/// Fixed-size string slots used by v2 Aeron discovery metadata.
pub const max_aeron_directory_length: usize = 512;
pub const max_aeron_channel_length: usize = 128;
